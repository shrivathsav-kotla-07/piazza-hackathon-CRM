...
from Timetable import get_data  # Your function to get data from MongoDB
    ...
    'function': {
        ...
        'parameters': {
            ...
            'properties': {
                'query': {
                    'type': 'object',
                    'description': 'MongoDB query dictionary to match data send only in dict formate . Example: {"age": 12}',
                }
            },
        },
    },
